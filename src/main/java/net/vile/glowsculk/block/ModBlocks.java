...
public class ModBlocks {
    ...
    public static final Block SCULK_CLUSTER = registerBlock("sculk_cluster", new Block(FabricBlockSettings.of(Material.AMETHYST).strength(2.5f).sounds(BlockSoundGroup.AMETHYST_CLUSTER).requiresTool().ticksRandomly()), ModItemGroup.HOWTO);
